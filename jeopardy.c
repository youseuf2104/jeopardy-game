...
int main(int argc, char *argv[]) {
    ...
    while (fgets(buffer, BUFFER_LEN, stdin) != NULL) { 
		...
		// Initialize Game
		initialize_game();
    	// Perform an infinite loop getting command input from users until game end
		int question_count = sizeof(questions);
		char *category;
		int value; 
	...
	// Back to the main loop to run infinitely
	}
	// Exit 
    return EXIT_SUCCESS;
}
